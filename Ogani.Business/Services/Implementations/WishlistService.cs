...
public class WishlistService : IWishlistService
{
    ...
    public WishlistService(IWishlistItemRepository wishListItemRepository, IHttpContextAccessor httpContextAccessor, IProductService productService)
    {
    ...
    public async Task<WishListCardDto> WishListCardDto()
    {
